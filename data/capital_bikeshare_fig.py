...
plt.title('Capital Bikeshare Rides by Week (2018-Present)')
plt.ylabel('Number of Rides')
plt.ylim((0,150000))
plt.xlabel('Dates (2018-Present)')
...
plt.savefig('04_Lineplot.png') #dpi=300)
...
#ax.set_ylabel('Ride Stations', fontsize=12)
ax = ax.set_title('Bikeshare Rides per Station (2018-Present)') #, fontsize=18, fontweight='bold')

plt.savefig('05_Barplot.png'), #dpi=300)
